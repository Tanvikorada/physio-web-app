...
export function ReportClient({ user, dateRange, summary, exercises }: ReportClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="mx-auto max-w-4xl bg-paper shadow-lg flex justify-center">
        {/* We fix the width to something akin to A4 at 96 DPI to make scaling predictable (approx 794px width) */}
        <div ref={reportRef} className="w-[794px] bg-paper p-12 text-ink flex flex-col gap-10">
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="col-span-1 bg-white p-5 rounded-xl border border-line flex flex-col items-center justify-center gap-4">
                    ...
                    <div className="text-center font-sans">
                      ...
                      <p className="text-xl font-serif text-ink">{ex.completedCount} of {ex.sessionsCount}</p>
                      <p className="text-xs text-ink/50 mt-1">Sessions Completed</p>
                    </div>
                  </div>
